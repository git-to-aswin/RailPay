...
CREATE SCHEMA IF NOT EXISTS card  AUTHORIZATION railpay_admin;
CREATE SCHEMA IF NOT EXISTS ref   AUTHORIZATION railpay_admin;
CREATE SCHEMA IF NOT EXISTS journey  AUTHORIZATION railpay_admin;
...
GRANT USAGE ON SCHEMA card, ref, journey, audit TO railpay_app, railpay_ro, railpay_dev;

REVOKE CREATE ON SCHEMA card, ref, journey, audit FROM railpay_app, railpay_ro, railpay_dev;
...
-- 6) Set search_path
ALTER ROLE railpay_admin SET search_path = card, ref, journey, audit, public;
ALTER ROLE railpay_app   SET search_path = card, ref, journey, audit, public;
ALTER ROLE railpay_dev   SET search_path = card, ref, journey, audit, public;
ALTER ROLE railpay_ro    SET search_path = card, ref, journey, audit, public;